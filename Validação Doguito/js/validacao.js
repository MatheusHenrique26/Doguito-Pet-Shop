export function valida(input) {
    ...
    if(input.validity.valid){
        ...
        input.parentElement.querySelector('.input-mensagem-erro').innerHTMIL =''
    }else{
...
const mensagemErro = {
    ...
    cpf:{
        ...
        customError : 'O CPF digitado não e valido. '
    },
    cep:{
        valueMissing:'O campo CEP não pode estar vazio.',
        patternMismatch:'O CEP digitado não e valido.',
        customError:'O CEP esta invalido.'
    },
    logradouro:{
    ...
    preco:{
        valueMissing:'O campo preço nao pode estar vazio'
    }
}
...
function recuperaCep(input) {
    ...
    fetch(url , options).then(
        ...
        data =>{
            if(data.erro){
                input.setCustomValidity('O CEP esta invalido.')
                return
